...
namespace sfw
{
	...
	// centered		  : if false, scale/rotation/translation will occur relative to the top-left corner of the image.
	...
	// angle		  : Rotation, in degrees.
	// offset		  : What character does our bitmap font start with? ' ' or 32 is common.
	// tint			  : a hex color value applied as a tint to the texture
